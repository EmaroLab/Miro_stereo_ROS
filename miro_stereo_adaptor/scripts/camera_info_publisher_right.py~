 ...
 * file camera_info_publisher_right.py
 ...
 * Subscribes to: ..<BR>
 * 
 * Publishes to: /yaml/right/camera_info<BR>
...
if __name__ == "__main__":
    ...
    #filename = args.filename #'ost.yaml'#
    ...
    publisher = rospy.Publisher("/yaml/right/camera_info", CameraInfo, queue_size=10)
    rate = rospy.Rate(4)
